...
function MSUpdate-DL
{
	...
	if ($details -eq $true) {
		...
		wget http://www.catalog.update.microsoft.com/Search.aspx?q=$request --user-agent="Mozilla/4.0 (compatible; MSIE 7.0; Windows NT 6.1; WOW64; SLCC2; .NET CLR 2.0.50727; .NET CLR 3.5.30729; .NET CLR 3.0.30729; Media Center PC 6.0; .NET4.0C; InfoPath.2)" --output-document $infofile
